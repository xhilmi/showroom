            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="store_name" value="HilmiNesia Showroom" class="form-control" id="name">
                ...
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="store_phone_number" value="085728518982" class="form-control" id="phone_number">
                  ...
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="store_email" value="hello@hostaja.com" class="form-control" id="email">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="store_tagline" value="Produk terjamin dan bergaransi panjang" class="form-control" id="tagline">
              ...
              <?php foreach ($banks as $bank) : ?>
                ...
                <div class="row alert alert-info">
                  ...
                  <div class="col-6">
                    ...
                    <input type="text" class="form-control" name="banks[<?php echo $n; ?>][name]" value="Hilmi Afifi">
                  </div>
                </div>
