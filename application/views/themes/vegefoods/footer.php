        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            ...
            <ul class="ftco-footer-social list-unstyled float-md-center float-lft mt-5" >
              <center>
              <li class="ftco-animate"><a href="https://api.whatsapp.com/send?phone=+6285728518982&text=Halo Hilmi! Saya ingin melakukan pembelian mobil." target='_BLANK'><span
                                        class="fab fa-whatsapp"></span></a></li>
			        <li class="ftco-animate"><a href="https://facebook.com/xhilmie" target='_BLANK'><span class="icon-facebook" ></span></a></li>
              <li class="ftco-animate"><a href="https://twitter.com/xhilmie" target='_BLANK'><span
                                        class="icon-twitter"></span></a></li>
              <li class="ftco-animate"><a href="https://www.instagram.com/xhilmie/"><span class="icon-instagram"></span></a></li>
              <li class="ftco-animate"><a href="https://www.youtube.com/@hilmiku" target='_BLANK'><span
